...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-bar-62c7)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/summer-bar-62c7
```

A live public deployment of this template is available at [https://summer-bar-62c7.templates.workers.dev](https://summer-bar-62c7.templates.workers.dev)
